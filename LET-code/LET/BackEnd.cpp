...
void startProgramme()
{
	...
	if (choice == "1")
	{
		...
		if (mode == "1")
		{
			...
			practisePresentSimpleTenseEx1(mutualChoice, points);
			practisePresentSimpleTenseEx2(mutualChoice, points);
			practisePresentSimpleTenseEx3(mutualChoice, points);
			practisePresentSimpleTenseEx4(mutualChoice, points);
		...
		else if (mode == "2")
		{
			...
			practisePresentContinuousTenseEx1(mutualChoice, points);
			practisePresentContinuousTenseEx2(mutualChoice, points);
			practisePresentContinuousTenseEx3(mutualChoice, points);
			practisePresentContinuousTenseEx4(mutualChoice, points);
		...
		else if (mode == "3")
		{
			...
			practisePastSimpleTenseEx1(mutualChoice, points);
			practisePastSimpleTenseEx2(mutualChoice, points);
			practisePastSimpleTenseEx3(mutualChoice, points);
			practisePastSimpleTenseEx4(mutualChoice, points);
		...
		else if (mode == "4")
		{
			...
			practisePastContinuousTenseEx1(mutualChoice, points);
			practisePastContinuousTenseEx2(mutualChoice, points);
			practisePastContinuousTenseEx3(mutualChoice, points);
			practisePastContinuousTenseEx4(mutualChoice, points);
		...
		else if (mode == "5")
		{
			...
			practisePresentPerfectTenseEx1(mutualChoice, points);
			practisePresentPerfectTenseEx2(mutualChoice, points);
			practisePresentPerfectTenseEx3(mutualChoice, points);
			practisePresentPerfectTenseEx4(mutualChoice, points);
		...
		else if (mode == "6")
		{
			...
			practiseFutureSimpleTenseEx1(mutualChoice, points);
			practiseFutureSimpleTenseEx2(mutualChoice, points);
			practiseFutureSimpleTenseEx3(mutualChoice, points);
			practiseFutureSimpleTenseEx4(mutualChoice, points);
