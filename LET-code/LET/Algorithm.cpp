...
void startProgramme()
{
	...
	string mode;
	string mutualChoice;
	string condition = "Enter The Answer: ";
	int points = 0;
	...
	if (choice == "1")
	{
		...
		if (mode == "1")
		{
			...
			// Practise Present Simple Tense Exercises 1
			...
			// Practise Present Simple Tense Exercises 2

			string sentence1[10] = { "1. A: Where are you from?\n  B: I __ from Bulgaria.",
			...
			string chooseAnswer1[10]{ "\n\n\ta) am  b) is","\n\n\ta) do  b) does","\n\n\ta) is  b) am",
			"\n\n\ta) study  b) studies","\n\n\ta) Do  b) Does","\n\n\ta) go  b) goes","\n\n\ta) Are  b) Is",
			"\n\n\ta) likes  b) like","\n\n\ta) know  b) knows","\n\n\ta) doesn't b) don't" };

			string answers1[10] = { "a" , "a" , "b" , "a" , "b" , "b" , "a" , "b" , "a" , "b" };
			...
			checkAnswerExMultipleChoice(sentence1, condition, mutualChoice, answers1, chooseAnswer1, points);

			// Practise Present Simple Tense Exercises 3

			string sentence2[10] = { "1. He love playing basketball.","2. They sleeps in afternoon.",
			...
			string answers2[10] = { "loves" , "sleep" , "gets" , "cook" , "go" , "have" , "goes" , "rises" , "like" , "play" };
			...
			CheckAnswerEx(sentence2, condition, mutualChoice, answers2, points);

			// Practise Present Simple Tense Exercises 4

			string sentence3[10] = { "1. He loves to play basketball.", "2. He goes to school.",
			...
			string answers3[10] = { "Does he love to play basketball?","Does he go to school?",
			...
			CheckAnswerEx(sentence3, condition, mutualChoice, answers3, points);

			displayTheResultOfTheExercises(points);
		...
		else if (mode == "2")
		{
			...
			// Practise Present Continuous Tense Exercises 1
			...
			// Practise Present Continuous Tense Exercises 2
			...
			string answers1[10] = { "a" , "a" , "b" , "a" , "a" , "b" , "a" , "b" , "a" , "b" };
			...
			// Practise Present Continuous Tense Exercises 3

			string sentence2[10] = { "1. The boys is playing football now.","2. They are learn Spanish now.",
			...
			string answers2[10] = { "are","learning","doing","is","studying","working","aren't","changing","are","talking" };
			...
			// Practise Present Continuous Tense Exercises 4
		...
		else if (mode == "3")
		{
			...
			// Practise Past Simple Tense Exercises 1
			...
			// Practise Past Simple Tense Exercises 2

			string sentence1[10] = { "1. Did she ___ her room?","2. We ___ good friends before.",
			...
			// Practise Past Simple Tense Exercises 3

			string sentence2[10] = { "1. I watch TV last week.","2. We eated meat with my best friend yesterday.",
			...
			string answers2[10] = { "watched" , "ate" , "stopped" , "met" , "left" , "bought" , "read" , "did" , "finished" , "went" };
			...
			string sentence3[10] = { "1. Tim arrived at 2.00.","2. Sam phoned home." , "3. Helen wanted to make a phone call.","4. Paul visited the doctor.",
			...
			string answers3[10] = { "Did Tim arrive at 2.00?" , "Did Sam phone home?" , "Did Helen want to make a phone call?" , "Did Paul visit the doctor?"
		...
		else if (mode == "4")
		{
			...
			// Practise Past Continuous Tense Exercises 1
			...
			// Practise Past Continuous Tense Exercises 2

			string sentence1[10] = { "1. A: What ___ you doing 10 minutes ago?\n  B: I was studying.",
			...
			string answers1[10] = { "b" , "a" , "b" , "a" , "b" , "b" , "a" , "b" , "a" , "a" };
			...
			// Practise Past Continuous Tense Exercises 3

			string sentence2[10] = { "1. They are drinking coffe when I arrived.","2. I was watch football match on TV when he called.",
			...
			string answers2[10] = { "were" , "watching" , "scaring" , "were" , "was" , "going" , "was" , "were" , "were" , "studying" };
			...
			// Practise Past Continuous Tense Exercises 4

			string sentence3[10] = { "1. Tim was drawing pictures.", "2. Kate and Bill were looking out of the window.","3. Ed and Lisa were reading a book.",
			...
			string answers3[10] = { "Was Tim drawing pictures?" , "Were Kate and Bill looking out of the window?" , "Were Ed and Lisa reading a book?"
		...
		else if (mode == "5")
		{
			...
			// Practise Present Perfect Tense Exercises 1
			...
			// Practise Present Perfect Tense Exercises 2

			string sentence1[10] = { "1. My mother ___ been watched TV.","2. They have been ___ the Lord of the Kings.",
			...
			// Practise Present Perfect Tense Exercises 3

			string sentence2[10] = { "1. I has worked as an engineer for two years.","2. My brother has drived a car before.",
			...
			string answers2[10] = { "have" , "driven" , "made" , "has" , "watched" , "has" , "eaten" , "have" , "has" , "been" };
			...
			string sentence3[10] = { "1. How long / you study English.", "2. How long / you have a cell phone.","3. How long / you have an e-mail address.",
			...
			string answers3[10] = { "How long have you studied English?" , "How long have you had a cell phone?" , "How long have you had an e-mail address?"
		...
		else if (mode == "6")
		{
			...
			// Practise Future Simple Tense Exercises 1
			...
			// Practise Future Simple Tense Exercises 2

			string sentence1[10] = { "1. A: What will you do this weekend?\n  B: A friend ___ come to visit me.",
			...
			// Practise Future Simple Tense Exercises 3

			string sentence2[10] = { "1. Your children was be the future of this country.","2. They are write the letter to their best friend tomorrow.",
			...
			string answers2[10] = { "will" , "will" , "will" , "rise" , "here" , "come" , "travel" , "will" , "going to" , "will not" };
			...
			// Practise Future Simple Tense Exercises 4

			string sentence3[10] = { "1. Your children will be the future of this country.","2. They will write the letter to their best friend tomorrow.",
			...
			string answers3[10] = { "Will your children be the future of this country?" , "Will they write the letter to their best friend tomorrow?"
	...
	else if (choice == "2")
	{
		...
		displayTheResultOfGuessTheWord(mutualChoice, points);
